...
$(document).ready(function() {
	...
	$('.copyright-info-container').prepend('<span class="footer-link-blog rfloat"><a href="https://blog.hostodom.com" title="Read Our Blog" target="_blank"><i class="fas fa-blog"></i>Company Blog</a></span><span class="footer-social-links rfloat">Follow us <a href="https://www.facebook.com/hostodom" title="Like us on Facebook" target="_blank"><i class="fab fa-facebook-square"></i></a><a href="https://twitter.com/hostodom" title="Follow us on Twitter" target="_blank"><i class="fab fa-twitter-square"></i></a><a href="https://pinterest.com/hostodom" title="Follow us on Pinterest" target="_blank"><i class="fab fa-pinterest-square"></i></a><a href="https://linkedin.com/company/hostodom" title="Connect with us on Linkedin" target="_blank"><i class="fab fa-linkedin"></i></a></span>');
