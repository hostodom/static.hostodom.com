//*** HOSTODOM FUNCTIONS @ 2021-06-10 15:02:13
...
$(document).ready(function() {
	...
	$('#page-footer .col.four .secondary-links li:nth-child(2) a').click(function(e){
		e.preventDefault();
		window.location = 'https://help.hostodom.com/portal/newticket';
	});
	$('#page-footer .col.misc .secondary-links li a').click(function(e){
		e.preventDefault();
		window.location = 'https://resellers.hostodom.com';
	});
	$('#page-footer .new-footer-style .footer-cols .col.four .secondary-links li:first-child').prepend('<li class="footer-view-ns"><a href="https://hostodom.freshdesk.com/support/solutions/articles/79000124991-name-servers-ns-for-your-domain" taget="_blank">View Name Servers (NS)</a></li>');
});
