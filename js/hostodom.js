...
$(document).ready(function() {
	...
	$('#branding .logo-cont').append('<span class="logo-support-info"><span class="logo-support-box"><i class="fas fa-award"></i><h5>30 Days Money-Back</h5><p>Satisfaction Guarantee!</p></span><span class="logo-support-box"><i class="fas fa-server"></i></i><h5>100% Reliability</h5><p>Top Notch Servers!</p></span><span class="logo-support-box"><i class="fas fa-power-off"></i><h5>99.9% Uptime</h5><p>Services Priority!</p></span></span>');
